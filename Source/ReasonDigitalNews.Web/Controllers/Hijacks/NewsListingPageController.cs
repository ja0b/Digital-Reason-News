...
namespace ReasonDigitalNews.Web.Controllers.Hijacks
{
    public class NewsListingPageController : RenderMvcController
    {
        ...
        public NewsListingPageController(JsonSerializerSettings jsonSerializerSettings, UmbracoMapper umbracoMapper, IContentResponseBuilder contentResponseBuilder)
        {
        ...
        public virtual ActionResult Index(NewsListingPage model)
        {
