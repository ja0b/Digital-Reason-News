...
{
    public partial class NewsPageController : RenderMvcController
    {
        private readonly JsonSerializerSettings _jsonSerializerSettings;
        private readonly UmbracoMapper _umbracoMapper;
        private readonly IContentResponseBuilder _contentResponseBuilder;

        public NewsPageController(JsonSerializerSettings jsonSerializerSettings, UmbracoMapper umbracoMapper, IContentResponseBuilder contentResponseBuilder)
        {
